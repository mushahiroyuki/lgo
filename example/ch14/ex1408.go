...
// Marshal は構造体のスライスの中の構造体のすべてを、文字列のスライスのスライスにマップする //liststart01
// 最初の行は列名が書かれたヘッダ //listend01
func Marshal(v any) ([][]string, error) { //liststart2
...
// Unmarshal は文字列のスライスのスライスの中のデータの行のすべてを構造体のスライスにマップする //liststart02
// 最初の行は列名が書かれたヘッダ  //listend02
func Unmarshal(data [][]string, v any) error { //liststart3
